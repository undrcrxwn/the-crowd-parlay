...
namespace CrowdParlay.Web.Menus;

public class CrowdParlayMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public CrowdParlayMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<CrowdParlayResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                CrowdParlayMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
